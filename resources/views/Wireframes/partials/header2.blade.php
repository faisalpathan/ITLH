  ...
  <div class="collapse navbar-collapse js-navbar-collapse">
    <ul class="nav navbar-nav">
      <li class="dropdown mega-dropdown">
        <a href="products" class="dropdown-toggle disabled" data-toggle="dropdown"><span class="glyphicon glyphicon-asterisk"></span>Mobile <span class="caret"></span></a>        
      ...
      <li class="dropdown mega-dropdown">
        ...
        <li class="dropdown">
          <a href="orderhistory" class=" ddropdown-toggle disabled" data-toggle="dropdown" role="button" aria-expanded="false">Order History<span class="caret"></span></a>
